...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of HQYNetWorking.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/shenghanming@sina.cn/HQYNetWorking'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'shenghanming@sina.cn' => 'shenghanming@sina.cn' }
  s.source           = { :git => 'https://github.com/shenghanming@sina.cn/HQYNetWorking.git', :tag => s.version.to_s }
